...
const Footer = () => {
  return (
    <footer className="bg-gradient-to-tr from-black to-emerald-800 text-white py-16">
      <div className="container mx-auto px-2 grid grid-cols-1 md:grid-cols-5 gap-8">
        ...
        <div className="flex flex-col space-y-4">
          ...
          <ul className="space-y-2">
            ...
            <li>
              <a href="#sengketa-waris" className="hover:text-main transition">
                Sengketa Waris
              </a>
            </li>
            <li>
        ...
        <div className="flex flex-col space-y-4">
          ...
          <ul className="space-y-2">
            ...
            <li>
              <a href="#surat-berharga" className="hover:text-main transition">
            ...
            <li>
              <a href="#ketenagakerjaan" className="hover:text-main transition">
