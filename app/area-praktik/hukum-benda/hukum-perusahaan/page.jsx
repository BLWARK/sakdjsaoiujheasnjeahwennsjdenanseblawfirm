    ...
    <div>
      ...
      <div className="relative w-full h-[400px]">
        ...
        <div className="absolute inset-0 bg-black/70 flex items-center justify-center">
          <h1 className="2xl:text-5xl text-xl font-bold text-main">Hukum Perusahaan/Niaga</h1>
        </div>
      </div>
      ...
      <section className="container mx-auto px-6 py-10">
        <div className="flex flex-col md:flex-row items-center">
          ...
          <div className="md:w-full ">
            ...
            Bagi Anda yang menjalankan bisnis, layanan hukum perusahaan kami dirancang untuk membantu kelancaran operasional dengan menyediakan:{" "}
            </p>
          </div>
        </div>
        <div className="md:w-full ">
          <ul className="list-disc pl-8 list-outside text-3xl font-bold text-main mb-4 font-playfair gap-2 flex flex-col">
            ...
            Konsultasi Bisnis: Analisis dan saran terkait hukum niaga yang relevan dengan bisnis Anda.
            </li>
            <li className="text-base  font-normal font-poppins text-gray-700 ">
            Penyusunan Dokumen Hukum: Kontrak kerja sama, dokumen perusahaan, dan kebijakan internal.
            </li>
            <li className="text-base  font-normal font-poppins text-gray-700 ">
            Penyelesaian Sengketa: Menangani konflik bisnis baik di dalam maupun di luar pengadilan.
            </li>
          </ul>
          <p className="text-gray-700 mb-6">
          Kami menjadi mitra hukum yang siap membantu Anda dalam menghadapi kompleksitas dunia bisnis.
          </p>
        </div>
        <div className="mt-10">
