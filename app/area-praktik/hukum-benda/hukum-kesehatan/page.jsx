    ...
    <div>
      ...
      <div className="relative w-full h-[400px]">
        ...
        <div className="absolute inset-0 bg-black/70 flex items-center justify-center">
          <h1 className="2xl:text-5xl text-xl font-bold text-main">Hukum Kesehatan (Malpraktek)</h1>
        </div>
      </div>
      ...
      <section className="container mx-auto px-6 py-10">
        <div className="flex flex-col md:flex-row items-center">
          ...
          <div className="md:w-full ">
            ...
            Kami membantu dalam menangani kasus malpraktik dengan pendekatan hukum yang adil, baik bagi pasien maupun tenaga medis. Layanan kami mencakup:{" "}
            </p>
          </div>
        </div>
        <div className="md:w-full ">
          <ul className="list-disc pl-8 list-outside text-3xl font-bold text-main mb-4 font-playfair gap-2 flex flex-col">
            ...
            Penyelesaian sengketa melalui negosiasi atau litigasi.
            </li>
            <li className="text-base  font-normal font-poppins text-gray-700 ">
            Konsultasi hukum terkait tanggung jawab medis.
            </li>
