    ...
    <div>
      ...
      <div className="relative w-full h-[400px]">
        ...
        <div className="absolute inset-0 bg-black/70 flex items-center justify-center">
          <h1 className="2xl:text-5xl text-xl font-bold text-main">Hukum Perbankan</h1>
        </div>
      </div>
      ...
      <section className="container mx-auto px-6 py-10">
        <div className="flex flex-col md:flex-row items-center">
          ...
          <div className="md:w-full ">
            ...
            Hukum perbankan memainkan peran penting dalam mendukung stabilitas finansial. Kami menawarkan:{" "}
            </p>
          </div>
        </div>
        <div className="md:w-full ">
          <ul className="list-disc pl-8 list-outside text-3xl font-bold text-main mb-4 font-playfair gap-2 flex flex-col">
            ...
            Konsultasi Regulasi Perbankan: Membantu bank dan lembaga keuangan mematuhi undang-undang yang berlaku.
            </li>
            <li className="text-base  font-normal font-poppins text-gray-700 ">
            Pengelolaan Kredit Bermasalah: Strategi penyelesaian kredit macet untuk melindungi kepentingan bank maupun debitur.
            </li>
            <li className="text-base  font-normal font-poppins text-gray-700 ">
            Penyelesaian Sengketa Perbankan: Mewakili Anda dalam kasus terkait perjanjian kredit, jaminan, dan layanan keuangan.
            </li>
          </ul>
          <p className="text-gray-700 mb-6">
          Kami memastikan bahwa semua hukum yang berkaitan dengan perbankan dapat terselesaikan dengan baik
          </p>
        </div>
        <div className="mt-10">
