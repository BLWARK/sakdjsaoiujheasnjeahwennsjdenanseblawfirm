    ...
    <div>
      ...
      <div className="relative w-full h-[400px]">
        ...
        <div className="absolute inset-0 bg-black/70 flex items-center justify-center">
          <h1 className="2xl:text-5xl text-xl font-bold text-main">Hukum Pasar Modal</h1>
        </div>
      </div>
      ...
      <section className="container mx-auto px-6 py-10">
        <div className="flex flex-col md:flex-row items-center">
          ...
          <div className="md:w-full ">
            ...
            Kami mendukung aktivitas di pasar modal dengan:{" "}
            </p>
          </div>
        </div>
        <div className="md:w-full ">
          <ul className="list-disc pl-8 list-outside text-3xl font-bold text-main mb-4 font-playfair gap-2 flex flex-col">
            ...
            Penawaran Umum Saham dan Obligasi: Pendampingan selama IPO dan pengelolaan regulasi terkait.
            </li>
            <li className="text-base  font-normal font-poppins text-gray-700 ">
            Konsultasi Investasi: Memberikan panduan hukum bagi investor dan perusahaan.
            </li>
            <li className="text-base  font-normal font-poppins text-gray-700 ">
            Penyelesaian Sengketa Pasar Modal: Melibatkan litigasi maupun mediasi.
            </li>
          </ul>
