    ...
    <div>
      ...
      <div className="relative w-full h-[400px]">
        ...
        <div className="absolute inset-0 bg-black/70 flex items-center justify-center">
          <h1 className="2xl:text-5xl text-xl font-bold text-main">Hukum Perjanjian/Perikatan</h1>
        </div>
      </div>
      ...
      <section className="container mx-auto px-6 py-10">
        <div className="flex flex-col md:flex-row items-center">
          ...
          <div className="md:w-full ">
            ...
            Kami memahami bahwa perjanjian adalah fondasi utama dalam setiap hubungan hukum. Tim kami siap membantu Anda dalam:{" "}
            </p>
          </div>
        </div>
        <div className="md:w-full ">
          <ul className="list-disc pl-8 list-outside text-3xl font-bold text-main mb-4 font-playfair gap-2 flex flex-col">
            ...
            Membuat perjanjian yang sesuai dengan kebutuhan, mulai dari kontrak bisnis hingga perjanjian pribadi.
            </li>
            <li className="text-base  font-normal font-poppins text-gray-700 ">
            Mendampingi Anda dalam proses negosiasi agar memperoleh kesepakatan terbaik.
            </li>
            <li className="text-base  font-normal font-poppins text-gray-700 ">
            Memberikan solusi hukum terbaik jika terjadi perselisihan akibat pelanggaran perjanjian.
            </li>
          </ul>
          <p className="text-gray-700 mb-6">
          Kami memastikan bahwa setiap perjanjian dibuat dengan bahasa hukum yang jelas, menghindari potensi konflik di masa depan.
          </p>
        </div>
        <div className="mt-10">
