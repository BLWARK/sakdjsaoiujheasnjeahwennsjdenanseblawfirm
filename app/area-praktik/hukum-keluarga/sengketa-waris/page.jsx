      ...
      <section className="container mx-auto px-6 py-10">
        <div className="flex flex-col md:flex-row items-center">
          ...
          <div className="md:w-full ">
            <h2 className="text-3xl font-bold text-main mb-4">Sengketa Waris</h2>
            <p className="text-gray-700 mb-6">
            Sengketa waris seringkali menimbulkan konflik dalam keluarga. Kami menawarkan solusi hukum yang adil dan efisien untuk menyelesaikan sengketa waris, baik melalui jalur mediasi maupun litigasi. Layanan kami mencakup:
            </p>
          </div>
        </div>
        <div className="md:w-full ">
          ...
          <ul className="list-disc pl-8 list-outside text-3xl font-bold text-main mb-4 font-playfair gap-2 flex flex-col">
            ...
            Penelaahan dokumen-dokumen hukum terkait warisan.
            </li>
            <li className="text-base  font-normal font-poppins text-gray-700 ">
            Penyelesaian sengketa waris sesuai hukum perdata atau hukum Islam.
            </li>
            <li className="text-base  font-normal font-poppins text-gray-700 ">
            Pengurusan penetapan ahli waris dan pembagian harta warisan secara sah.
            </li>
            
          </ul>
          <p className="text-gray-700 mb-6">
          Kami mengedepankan komunikasi yang baik untuk membantu menyelesaikan masalah tanpa memperburuk hubungan keluarga.
            </p>
        </div>
        <div className="mt-10">
